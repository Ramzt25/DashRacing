...
export async function registerRaceRoutes(app) {
    // Get all races
    app.get('/races', async () => {
    ...
    app.post('/races', { preHandler: [authGuard] }, async (req, reply) => {
        try {
    ...
    // Join a race
    app.post('/races/:id/join', { preHandler: [authGuard] }, async (req, reply) => {
        try {
    ...
    // Leave a race
    app.delete('/races/:id/leave', { preHandler: [authGuard] }, async (req, reply) => {
        try {
            const { id: raceId } = req.params;
    ...
    app.post('/races/:id/results', { preHandler: [authGuard] }, async (req, reply) => {
        try {
            const { id: raceId } = req.params;
    ...
    app.post('/races/:id/sessions', { preHandler: [authGuard] }, async (req, reply) => {
        try {
            const { id: raceId } = req.params;
    ...
    app.patch('/races/sessions/:sessionId/end', { preHandler: [authGuard] }, async (req, reply) => {
        try {
